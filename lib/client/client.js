(function () {
    ...
    var getPieceName = function (p) {
        switch (true) {
        case p instanceof chess.chess_Knight    : return "N";
        case p instanceof chess.chess_Rook      : return "R";
        case p instanceof chess.chess_Bishop    : return "B";
        case p instanceof chess.chess_Queen     : return "Q";
        case p instanceof chess.chess_King      : return "K";
        default                                 : return "";
        }
    };
